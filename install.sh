...
echo -e "$OKRED  _    _                  _       _____                 $RESET"
echo -e "$OKRED | |  | |                | |     / ____|                $RESET"
echo -e "$OKRED | |__| |   __ _    ___  | | __ | |  __   _   _   _ __  $RESET"
echo -e "$OKRED |  __  |  / _  |  / __| | |/ / | | |_ | | | | | | |_ \ $RESET"
echo -e "$OKRED | |  | | | (_| | | (__  |   <  | |__| | | |_| | | | | |$RESET"
echo -e "$OKRED |_|  |_|  \__,_|  \___| |_|\_\  \_____|  \__,_| |_| |_|$RESET"
echo -e "$OKORANGE + -- --=[hgig v$VER by BlackHacker(DEEPAN)"
echo ""

INSTALL_DIR=/usr/share/hgig
LOOT_DIR=/usr/share/hgig/loot
PLUGINS_DIR=/usr/share/hgig/plugins

echo -e "$OKGREEN + -- --=[This script will install hgig under $INSTALL_DIR. Are you sure you want to continue?$RESET"
read answer 
...
wget https://raw.githubusercontent.com/1N3/IntruderPayloads/master/FuzzLists/dirbuster-quick.txt -O /usr/share/hgig/plugins/cansina/dirbuster-quick.txt
...
ln -s $INSTALL_DIR/hgig /usr/bin/hgig
